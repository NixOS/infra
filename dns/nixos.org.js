D("nixos.org",
	...
	CNAME("hydra", "mimas.nixos.org."),

	A("pluto", "37.27.99.100"),
	AAAA("pluto", "2a01:4f9:3070:15e0::1"),
	CNAME("alerts", "pluto.nixos.org."),
	CNAME("grafana", "pluto.nixos.org."),
	CNAME("monitoring", "pluto.nixos.org."),
	CNAME("prometheus", "pluto.nixos.org."),
  ...
  A("enormous-catfish.mac", "142.132.140.199"),
	...
	CNAME("chat", "caliban.nixos.org."),
	CNAME("live", "caliban.nixos.org."),
	CNAME("matrix", "caliban.nixos.org."),
	CNAME("survey", "caliban.nixos.org."),
	CNAME("vault", "caliban.nixos.org."),
	DMARC_BUILDER({
		label: "caliban",
		policy: "none"
	}),
