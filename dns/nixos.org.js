D("nixos.org",
	...
	CNAME("cache", "dualstack.n.sni.global.fastly.net.", TTL(300)),
	CNAME("cache-staging", "dualstack.n.sni.global.fastly.net.", TTL(300)),
	CNAME("channels", "dualstack.n.sni.global.fastly.net.", TTL(300)),
	CNAME("artifacts", "dualstack.n.sni.global.fastly.net.", TTL(300)),
	CNAME("releases", "dualstack.n.sni.global.fastly.net.", TTL(300)),
	CNAME("tarballs", "dualstack.n.sni.global.fastly.net.", TTL(300)),
